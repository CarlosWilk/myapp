...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Jan-2023 às 14:12
...
(23, 'Flavia de Oliveira', '083 999 9998', 'flavia@test.com', '2022-12-31', '15.00PM-17:00PM', 1, '05-D-12387', 1, 1, 'Dead Battery', 1, 7),
...
(35, 'Mario Bros', '082 010 1232', 'mario@test.com', '2023-01-20', '11.00AM-13:00PM', 30, '23-01-1BW8', 1, 3, 'driver side window not going down', 1, 4);
...
(684, 123456, '2023-01-08 12:11:58', 0, 2, 'Flavia', '', '97.00', '4.85', 0.00, '5', 101.85, '0.00', '101.85', 'Available for collection this afternoon'),
(685, 123456, '2023-01-08 12:19:21', 0, 3, 'Mario', '', '638.00', '31.90', 0.00, '5', 669.90, '0.00', '669.90', 'Changed suspension'),
(686, 123456, '2023-01-11 20:24:01', 0, 1, 'Flavia', '083 999 9998', '530.00', '53.00', 0.00, '10', 743.00, '100.00', '643.00', 'Small repair'),
(687, 123456, '2023-01-11 20:43:19', 0, 2, 'Mary123', '080 999 8888', '177.00', '0.00', 0.00, '0', 177.00, '0.00', '177.00', 'Ready to collection'),
(689, 123456, '2023-01-14 23:26:29', 0, 1, 'Mario', '082 010 1232', '72.00', '3.60', 0.00, '5', 75.60, '0.00', '75.60', 'changed mirror'),
(690, 123456, '2023-01-15 11:11:47', 20, 2, 'Mario Bros', '083 999 9999', '250.00', '25.00', 100.00, '10', 375.00, '0.00', '375.00', 'Changed battery'),
(691, 123456, '2023-01-15 11:35:52', 21, 0, 'Augusto Torres', '083 999 9933', '98.00', '9.80', 150.00, '10', 207.80, '0.00', '257.80', 'Changed 2 the ignition coil');
...
--
ALTER TABLE `invoice_order_item`
  MODIFY `order_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4381;
